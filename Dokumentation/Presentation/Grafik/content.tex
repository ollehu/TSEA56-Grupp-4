...
\begin{frame}{Styrmodulen}{Grupp 4 - PigBots}
	\begin{columns}
		\begin{column}{0.5\textwidth}
...
\begin{frame}{Datormodulen - designmönster}{Grupp 4 - PigBot}
\centering
	\includegraphics[width=0.9\textwidth]{images/modelViewController.pdf}
\end{frame}

\begin{frame}{Datormodulen - användargränssnitt}{Grupp 4 - PigBot}
