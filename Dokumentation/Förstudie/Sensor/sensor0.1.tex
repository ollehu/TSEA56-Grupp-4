...
För att mäta avstånd mellan roboten och väggarna vid sidan av denna kommer en IR-sensor av modell GP2D120 att användas. Sensorn mäter avståndet med hjälp av att sända ut strålning med en viss våglängd, detektera reflektionen av strålningen och mäta vinkeln för den reflekterade strålen. I figur 2 illustreras hur olika avstånd ger upphov till olika vinklar.
...
För att mäta den reflekterande strålens vinkel används reflektionslagen, där infallsvinkeln är densamma som reflektionsvinkeln enligt figur 3. http://mynixworld.info/2013/09/10/reflektion-och-brytning/
...
Sensorns analoga utsignal (V) beror av avståndet till objektet som reflekterar IR-ljuset enligt figur 1, i vilken det kan observeras att olika avstånd kan ge upphov till samma utsignal. Därmed används sensorn enbart för distanser från 4 cm och uppåt, då en utsignal endast motsvaras av ett avstånd. När avståndet till objekt minskar den analoga utsignalen och vid 30 cm blir utsignalen för svag för att avläsas precist. Sensorns mätvidd är alltså 4-30 cm. http://www.student.ugent.be/ieee/sites/default/files/Range_SHARPGP2D120.pdf 





Den analoga utsignalen görs sedan om till ett 8-bitars digitalt värde enligt ekvation 1, där varje digitalt värde motsvarar ett avstånd angivet i cm.


Ekvation 1
 
http://www.abotics.com/OPEN_ROBOT_DOCS/OPEN_ROBOT_GP2D120_Light_Sensors.pdf
