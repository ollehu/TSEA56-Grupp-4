...
Roboten kommer ha två olika styrmoder: \textit{rak körning i korridor} och \textit{rotation}. Av dessa två är det \textit{rak körning i korridor} som presenterar den största utmaningarna. Reglerering av rotationen sker intuitivt med en PD-reglering, varför den inte kommer beskrivas mer ingående här. 
