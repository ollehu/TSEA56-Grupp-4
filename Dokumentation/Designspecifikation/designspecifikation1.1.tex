...
På ett av chassits hjul placeras en skiva bestående av 12 stycken svarta och vita sektioner. En reflexsensor placeras mot skivan och mäter antalet flankar mellan sektionerna som passerar. Denna information används sedan av styrmodulen för att beräkna tillryggalagd sträcka.
...
Reflexsensorn används för att beräkna antal varv som robotens hjul roterar. Då skivan som placeras på hjulet består av 12 stycken sektioner kan tillryggalagd sträcka bestämmas med en precision på $left(\pi \diameter / 12\right)$ där $\diameter$ är diametern på hjulet. Sensorn kopplas in till en ADC-ingång hos processorn.
