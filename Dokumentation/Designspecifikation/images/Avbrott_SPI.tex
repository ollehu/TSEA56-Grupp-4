...
\node[block, below of = start, node distance = 3cm](initADC){Initiera SPI};
\node[decision, below of = initADC](int2){SPIF};

\node[block, right of = int2, node distance = 3cm](in_sensor){Omvandlar vinkelhastighet och acceleration till lämplig SI-enhet};
