...
\subsubsection{Reglering}
När styrmodulen tar emot ett kommando från huvudmodulen så regleras servona utifrån de senaste mottagna sensorvärdena. Den reglering som programmeras till modulen består av två komponenter. Den ena ser till att roboten färdas i mitten av korridoren och den andra anpassar hastigheten utifrån korridorens längd.
