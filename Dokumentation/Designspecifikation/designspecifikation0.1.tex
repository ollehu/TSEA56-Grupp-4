...
Sampling bör ske så ofta som möjligt(eller finns det begränsning hos styrmodulen?). Det som begränsar tiden mellan samplingarna är den sensor som tar längst på sig i A/D omvandlingen eftersom alla sensorvärden skickas till styrmodulen på en gång. 
