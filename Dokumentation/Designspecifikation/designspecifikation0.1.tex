...
GP2D120 och IRM-8601-S reflekterar ljus för att mäta avstånd till omgivande objekt och för att identifiera den nödställde. Utsignalen vid dessa operationer är spänning (Vout), vilken behöver omvandlas till ett digitalt värde för att kunna skicka vidare informationen. Omvandlingen sker via 

\begin{equation*}
	\textrm{Digitalt värde} = \frac{255}{5}V_{out}
\end{equation*}

där den maximala utsignalen är 5 volt. Det analoga värdet delas upp i 256 digitala värden som motsvarar olika spänningar. Sambandet mellan spänning och avstånd till väggen kan utläsas av figur \ref{IR_avstand}. Av figuren är det uppenbart att någon typ av bearbening, utöver A/D-omvanlingen, kommer krävas för att få ett linjärt förhållande mellan avståndet och det digitala värdet. IR-sensorerna behöver även lågpassfiltreras, vilket görs genom multiplexning genom ett LP-filter.
...
Eftersom I\textsuperscript{2}C-kommunikationen är avbrottstyrd består styrmodulens uppdrag till största del av att besvara kommandon från huvudmodulen. När ett avbrott signaleras betjänas det direkt och kallar på olika metoder utgående från den typ av information som anländer. 
