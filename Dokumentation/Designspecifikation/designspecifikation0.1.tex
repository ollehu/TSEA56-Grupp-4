...
\noindent\resizebox{.6\linewidth}{!}{
	...
	\caption{Flödesschema som beskriver förloppet vid avbrott på ingång INT0 \label{avbrott_korlage}}	
\end{figure}
...
\noindent\resizebox{.6\linewidth}{!}{
	...
	\caption{Flödesschema som beskriver förloppet vid avbrott på ingång INT1 \label{avbrott_strombrytare}}	
\end{figure}
...
\noindent\resizebox{1\linewidth}{!}{
	...
	\caption{Flödesschema som beskriver förloppet vid avbrott på ingång INT2 \label{avbrott_sensormodul}}	
\end{figure}
