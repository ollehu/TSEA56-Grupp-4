...
\begin{tikzpicture}[scale=1,rotate=0]
	...
	\draw  node[left, align=center, text width=5cm] at (6,1.5) {Graf över historiska sensordata};
	
	%Buttons
	\draw[thick, draw=black, fill=white] (7,0.5) rectangle (9.5,2.5);
	\draw  node[left, align=center, text width=2cm] at (9.4,1.5) {Panel för knappar};
