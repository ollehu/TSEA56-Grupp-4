...
Varje individ i gruppen ansvarar för sin egen utbildning och för att ha de kunskaper som krävs för att genomföra projektet. Dessa timmar kommer att plockas från en \textit{utbildningspool} som innefattar \textcolor{red}{x} antal timmar. Utbildningsområde beror på medlemmens arbetsuppgifter och består i grunden av C, Git och \LaTeX. 
