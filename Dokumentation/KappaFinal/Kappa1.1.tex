...
\includepdf[pages=-]{Reglering.pdf}

\section{Förstudie - Kommunikation}
\includepdf[pages=-]{Kommunikation.pdf}

\section{Förstudie - Sensor}
\includepdf[pages=-]{Sensor.pdf}

\section{Designspecifikation}
\includepdf[pages=-]{Designspecifikation.pdf}

\section{Teknisk dokumentation}
\includepdf[pages=-]{TekniskDokumentation.pdf}

\section{Användarhandledning}
\includepdf[pages=-]{AnvHandledning.pdf}

\section{Testprotokoll}
\includepdf[pages=-]{TestprotokollMall.pdf}
\includepdf[pages=-]{Test1.pdf}
\includepdf[pages=-]{Test2.pdf}
\includepdf[pages=-]{Test3.pdf}
