...
Det genomförda projektet har gått ut på att konstruera en undsättningsrobot. Detta dokument syftar till att användas som underlag till personer som vill bygga en liknande robot. Innehållet består av detaljerade beskrivningar av systemets olika delar och dess mjuk- och hårdvarukomponenter samt implementation.

\section{Produkten}
\textit{En bild på produkten och en beskrivning av hur den fungerar. Beskriv vad den används till.}
Produkten som har konstruerats är en undsättningsrobot bestående av fyra moduler varav tre är, tillsammans med sensorer och en gripklo, integrerade på ett gemensamt chassi enligt figur \ref{overview}. Den fjärde modulen är en dator som visar lämplig information. ÄNDRA TILL 1284P OCH EV GP2D120
...
Huvudmodulen har som uppgift att ta emot och förmedla information mellan de andra modulera samt tar alla övergripande beslut. Bluetooth\textsuperscript{\circledR} används för att kommunicera med datormodulen och en I\textsuperscript{2}C-buss används för att kommunicera med sensor- och styrmodulen, vilket visas i figur \ref{communication}.
