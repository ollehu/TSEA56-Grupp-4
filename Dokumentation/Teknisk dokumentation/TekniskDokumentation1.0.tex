...
Produkten som konstrueras är en undsättningsrobot bestående av fyra moduler varav tre är, tillsammans med sensorer och en gripklo, integrerade på ett gemensamt chassi enligt figur \ref{overview}. Den fjärde modulen är en dator som visar sensordata och en karta över utforskade moduler.
