...
Det som avgör vad roboten tar för beslut är om kortaste väg kan garanteras och om målet är funnet, vilket illustreras i figur \ref{blockSystem}.
...
\begin{itemize}
	...
	\item D (1 byte) - Information om vad som finns i noden.
	\begin{itemize}
		\item 0-225 - Utforskat
		\item 242 - Startposition
		\item 243 - Målets position
		\item 244 - Vägg
		\item 245 - Upptäckt men ej utforskad
	\end{itemize}
\end{itemize}
...
\centering
\noindent\resizebox{0.9\linewidth}{!}{
	\includegraphics[scale=1]{images/sensormodul.eps}}
...
\noindent\resizebox{\linewidth}{!}{
	...
	\caption{Kopplingsschema över huvudmodul \label{kopplingsschema:sensormodul}}	
\end{figure}
