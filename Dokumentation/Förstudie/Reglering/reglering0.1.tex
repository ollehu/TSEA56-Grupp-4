...
\begin{itemize}
	...
	\item [-] Vilka kartsökningsalgoritmer ger en effektiv avsökningsekvens av en okänd labyrints korridorer?
	\item [-] Givet en karta över en labyrint, hur kan då den kortaste vägen mellan två punkter berkäknas?
\end{itemize}
\subsubsection{Avgränsning}
De labyrinter som beaktas i förstudien är utformade enligt en banspecifikation från appendix C. Labyrinten är begränsad, enkelt sammanhängande och har alla korridorer i samma plan. Dessutom finns inga öppna rum vilket avgränsar samtliga tre underrubriker till att enbart kartlägga, följa och optimera en väg genom korridorer. 
