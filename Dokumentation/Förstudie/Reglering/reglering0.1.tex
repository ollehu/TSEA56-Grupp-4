		...
		\Function{DijkstrasAlgorithm}{Graph, s}	
			...
			\While {$Q \neq \emptyset$}
				...
				\Comment{Itererare över grannar till $u$}
					\If {$\text{dist}(u) + w(u,v) < \textrm{dist}(v)$}
...
$h(n)$ kan ses som en straffunktion som avtar nära slutnoden. A* kan alltså till skillnad från Dijkstras algoritm se framåt i nätverket och är därför en mer effektiv algoritm.
\pagebreak
