...
I detta kapitel presenteras det syfte samt de frågeställningar som ligger till grund för denna förstudie.
...
Med hjälp av pulsbreddsmodulering kan förhållandet mellan en hög signal (en etta) och en låg signal (en nolla) bestämmas. Utifrån denna kvot kan sensorn kalibreras och en förhållande mellan en kvot och ett avstånd kan tas fram. Alternativt går det att mäta tiden för en hög signal och använda sig av att LIDAR-Lite v2 är förprogrammerat på så sätt att en mikrosekund motsvarar en centimeter. \cite{Lidar}
