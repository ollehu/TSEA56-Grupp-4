...
Granskad & Zimon Inge & 2016-04-22 \\ \hline
Godkänd & - & - \\ \hline
...
1.0 & 2016/04/22 & Tredje utkastet & Grupp 4 & ZI \\ \hline
...
En annan typ av lasersensor är den triangulerade sensorn. De är mer komplex och kan mäta avstånd på ett mer precist sätt än den elektrooptiska. Genom att sända ut en laserstråle från en punkt (A) och detektera den i en annan (B) erhålls två vinklar (\alpha & \beta) enligt figur \ref{Triangulation}. 
