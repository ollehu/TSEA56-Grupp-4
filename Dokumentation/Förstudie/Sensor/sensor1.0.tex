...
En annan typ av lasersensor är den triangulerade sensorn. De är mer komplex och kan mäta avstånd på ett mer precist sätt än den elektrooptiska. Genom att sända två laserstrålar från två olika positioner erhålls två vinklar enligt figur?!?!. Med hjälp av beräkningar enligt ekvation \ref{triangulation} fås avståndet till objektet. \cite{website:triangulation} \cite{website:mti}
