...
Hade projektet gjorts om från början hade bantester tidigare kommit med i tidplanen. Nu blev det en stor post efter ett tag då det upptäcktes att alla aktiviteter inte tog så lång tid som det initialt antogs göra och denna tog mer tid. Att från start använda ett pålitligare sätt att mäta avlagd sträcka än lasersensorn hade varit idé att göra, alltså från början göra bättre undersökningar om alternativ av sensorer och hur pålitliga dessa är. Att vara fler än en person som kan varje specifik del kod. I projektet var det en medlem som i princip ensam arbetade med datormodulens kod. Arbetsbördan hade kunnat fördelas bättre om fler var insatta i denna kod och kunde hjälpa de övriga gruppmedlemmarna. Detta gäller all kod. Något som hade underlättat arbetet hade varit att från början sätta upp standard för testprotokol och vara noga med att fylla i dem så inte samma fel felsöks flera gånger när en lösning funnits tidigare exempelvis.

\subsection{Utvecklingsmöjligheter}
Om gruppen hade haft mer tid till förfogande, eller om någon vill ta vid där detta projekt avslutas, finns det några punkter med utvecklingsmöjligheter. Ett mindre prioriterat krav, som i genomfört projekt inte har uppfyllts, är att roboten ska klara av att navigera i öppna rum. Det är något som är relevant för en undsättningsrobot eftersom grottsystem sällan består enbart av korridorer. Att roboten skulle klara av att genomföra svängar som kan vara av godtycklig vinkel, inte bara 90 och 180 grader, är också en kvalitet som skulle höja robotens verkliga förmåga som undsättare. 

Att förbättra datorprogrammet och göra det snyggare grafiskt är också något som kan utvecklas. Ju mer användarvänligt och visuellt attraktivt programmet är, desto roligare är det för en användare att använda produkten. En bättre optimerad avsökning kan även vara värd att arbeta på, såväl som att uppfylla de krav av lägre prioritet som i detta projekt inte har blivit uppfyllda. 
