...
Trots att arbetet delats upp i olika moduler är det viktigt att ha i åtanke att dessa ska vara en del av ett större system. Modulerna kan fungera felfritt var och en för sig men motverka varandra vid integrering. Detta kan exempelvis ske om en moduls avbrott upptar för mycket tid, vilket gör att de andra modulerna tappar effektivitet. 
