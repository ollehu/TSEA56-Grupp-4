...
int main (void)
{
	...
	while(1) { 
		...
		sensorData[1] = 1;
		sensorData[2] = (int) (SI_IR11/5.0 + SI_IR12/5.0 + SI_IR13/5.0 + SI_IR14/5.0 + SI_IR15/5.0); //Höger fram
		sensorData[3] = 2;
		sensorData[4] = (int) (SI_IR31/5 + SI_IR32/5 + SI_IR33/5 + SI_IR34/5 + SI_IR35/5); //Vänster fram
		sensorData[5] = 3;
		sensorData[6] = (int) (SI_IR21/5 + SI_IR22/5 + SI_IR23/5 + SI_IR24/5 + SI_IR25/5); //Höger bak
		sensorData[7] = 4;
		sensorData[8] = (int) (SI_IR41/5 + SI_IR42/5 + SI_IR43/5 + SI_IR44/5 + SI_IR45/5); // Vänster bak
